...
const AboutPage = () => {
  return (
    <section className="p-2 flex flex-col gap-5 mt-5 justify-center items-center text-cyan-100">
      ...
      <p className="text-xl md:text-3xl text-balance text-center">I am a junior Full-Stack devloper, although, I am inclined towards Front-end as a visual person but nevertheless, I am passionate about bringing ideas to life and experimenting with new technologies for better understanding. I thrive on creating seamless, user-friendly experience. Let’s collaborate and build something extraordinary together.</p>
